...
def make_confusion_matrix(y_true, y_pred, classes=None, figsize=(10, 10), text_size=15, norm=False, savefig=False,x_labels_rotate = False):
...
def plot_loss_curves(history,model_num):
    """
    Returns separate loss curves for training and validation metrics.

    Args:
      history: TensorFlow model History object (see: https://www.tensorflow.org/api_docs/python/tf/keras/callbacks/History)
      model_num: Specify model title/number
    """
    ...
    plt.title("Model {}".format(model_num))
    plt.title('Loss')
    plt.xlabel('Epochs')
    plt.legend()
